...
func usage() {
  ...
  report [-days N] [-lane l] [-json]  receipts dashboard from dispatch.jsonl — offline, deterministic (window anchors to the newest receipt, never the clock)
  ...
  run "<prompt>" [--lane claude|codex|copilot|glm|groq|cloudflare|openrouter|nim|gemini|auto] --model <id> [--effort e] [--live] [--force]
